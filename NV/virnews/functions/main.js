...
const config = {
 ...
 const getPosts = async() => {
    let docs;
    let postsRef = firebase.firestore().collection("posts").orderBy("timestamp", "desc").limit(3);
...
const paginate = async () => {
    let docs;
    let postsRef = firebase.firestore().collection("posts").orderBy("timestamp", "desc")
